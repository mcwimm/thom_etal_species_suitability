...
dat = dat %>% 
  mutate(cat = ifelse(score_1 > 4, "very suitable (4, 5]",
                      ifelse(score_1 > 3, "suitable (3, 4]",
                             ifelse(score_1 > 2, "partially suitable (2, 3]",
                                    "unsuitable (1, 2]")))) 
...
ggsave("figs/tab1.jpg", width = 8.5, height = 12)
```
...
ggsave("figs/table_2_as_figure.jpg", height = 10, width = 7)
```
...
ggsave(paste("figs/fig_4_", trait, "_density2.jpg", sep = ""), width = 6, height = 7.3)
```
